...
```bash
npm install @stdlib/napi-argv-strided-uint16array2d
```
...
```javascript
var headerDir = require( '@stdlib/napi-argv-strided-uint16array2d' );
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/napi-argv-strided-uint16array2d.svg
[npm-url]: https://npmjs.org/package/@stdlib/napi-argv-strided-uint16array2d

[test-image]: https://github.com/stdlib-js/napi-argv-strided-uint16array2d/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/napi-argv-strided-uint16array2d/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/napi-argv-strided-uint16array2d/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/napi-argv-strided-uint16array2d?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/napi-argv-strided-uint16array2d.svg
[dependencies-url]: https://david-dm.org/stdlib-js/napi-argv-strided-uint16array2d/main
...
[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/napi-argv-strided-uint16array2d/main/LICENSE
